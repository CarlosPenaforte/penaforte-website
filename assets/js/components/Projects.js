...
export default Infimo.default.defineComponent({
    ...
    template: `
        <div id="projects-section" class="flex flex-col bg-gray-200 text-gray-900 select-none rounded-lg px-3 py-3 md:py-4 md:px-6 justify-center">
            ...
            <p class="text-base">
                <span class="text-[inherit]">Here are some interesting projects I worked on recently. You can find more of my work on my </span><a href="https://github.com/cpenaforte" target="_blank" title="Go to Github profile" class="text-[rgb(0,130,180)] hover:text-[rgb(50,150,210)] hover:underline active:text-[rgb(0,130,180)]">GitHub profile</a>.
            </p>
